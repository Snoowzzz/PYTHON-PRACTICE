...
# # print(f"Base array :{num}")
# # num_10 =[x*10 if x%2 ==0 else x for x in num]
# # print(f"Transformed array : {num_10}")

# # Raw user inputs or dirty network flags
# raw_flags = ["HTTP", "Https", "ssh", "AWS_EC2", "S3_BUCKET"]

# # ONE-LINER: Lowercase every string dynamically
# clean_flags = [flag.lower() for flag in raw_flags]

# print(f"Normalized Flags: {clean_flags}")



# typing_scores = [87,88,95,108,86,81,99,97,105]
